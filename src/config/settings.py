"""Application configuration for Kubernetes Operations Agent."""
...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="kubernetes-operations-agent", description="Application name")
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/kubernetes_operations_agent",
    ...
    opensearch_index: str = Field(default="kubernetes_operations_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="kubernetes-operations-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="kubernetes-operations-agent", description="A2A agent ID")
