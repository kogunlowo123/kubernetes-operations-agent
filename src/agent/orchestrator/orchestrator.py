"""Kubernetes Operations Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Kubernetes Operations Agent through a multi-step pipeline.
